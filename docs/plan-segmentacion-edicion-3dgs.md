...
shared/                      splat-io, graph(+worker), lift, naming, edit-ops, export-io, tsdf(+worker), glb, schemas.js, schemas/instancias.schema.json, synthetic, instances
semantic_sidecar/            server.py (/analyze, /card, /segment, /name, /segmentaciones, /exportaciones, /mallas)
scripts/                     un solo uso: vendor-gaussforge.sh, download-ml-models.sh, bench-graph.mjs, validate-instancias.mjs, render-mermaid.mjs, render-report-pdf.mjs
