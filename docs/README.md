...
| File | What it is |
| --- | --- |
| [open-vocab-3dgs-imagine-pipeline-paper.md](open-vocab-3dgs-imagine-pipeline-paper.md) | Technical report: SAM 2.1 browser segmentation, reciprocal cross-view association, real-GPU profile, splat-to-mesh/3MF mathematics, figures, references and attributions |
