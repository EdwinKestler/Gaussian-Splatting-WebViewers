...
| `tests/e2e/f6-mesh.spec.mjs` | Aceptación F6: GLB glTF 2.0 válido con radio/color correctos y estado de topología explícito; exportación de la escena visible conserva sus componentes y usa `*_escena.glb`; rutas 3MF de instancia y escena por marching tetrahedra con 0 bordes abiertos, 0 aristas no-manifold, escala exacta de 80 mm, z=0, partes OPC requeridas y persistencia `.3mf`; cámara y aislamiento restaurados; profundidad mediana también cubierta |
